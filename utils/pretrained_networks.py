...
class squeezenet(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        pretrained_features = \
            tv.squeezenet1_1(pretrained=pretrained).features
...
class alexnet(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        alexnet_pretrained_features = \
            tv.alexnet(pretrained=pretrained).features
        self.slice1 = torch.nn.Sequential()
        self.slice2 = torch.nn.Sequential()
        self.slice3 = torch.nn.Sequential()
        self.slice4 = torch.nn.Sequential()
    ...
    def forward(self, X):
        ...
        alexnet_outputs = namedtuple('AlexnetOutputs', ['relu1', 'relu2'
                , 'relu3', 'relu4', 'relu5'])
        out = alexnet_outputs(h_relu1, h_relu2, h_relu3, h_relu4,
                              h_relu5)
...
class vgg16(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        vgg_pretrained_features = \
            tv.vgg16(pretrained=pretrained).features
        self.slice1 = torch.nn.Sequential()
        self.slice2 = torch.nn.Sequential()
        self.slice3 = torch.nn.Sequential()
        self.slice4 = torch.nn.Sequential()
...
class resnet(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        outputs = namedtuple('Outputs', ['relu1', 'conv2', 'conv3',
                             'conv4', 'conv5'])
